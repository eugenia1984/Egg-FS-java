Algoritmo Horarios
	...
	Escribir "Ingrese una cantidad de días, para indicarle su equivalente en horas, minutos y segundos: "       ///Pido ingrese la cantidad de días
...
// escribir un programa que convierta lso días en horas, minutos y segundos.
