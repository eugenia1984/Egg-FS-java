...
public class Guia9Ejercicio3 {
    ...
    public static void main(String[] args) {
        ...
        //creo dos lavadoras
        Lavadora lavadora1 = new Lavadora(40, "blanco", 'A', 20);
        Lavadora lavadora2 = new Lavadora(10, "blanco", 'A', 20);
        //creo dos televisores
        Televisor televisor1 = new Televisor(10, true, "Azul", 'A', 10);
        Televisor televisor2 = new Televisor(10, true, "Azul", 'A', 30);
