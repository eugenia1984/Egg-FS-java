Algoritmo ParOImpar
	...
	Escribir " Por favor ingrese un número para decirle si es par o impar y llamamos a la función que nos va a decir VERDADERO si es par y FALSO si es impar: "
	Leer num1
	
	Si num1 MOD 2 = 0 Entonces
		Escribir num1, " es par ", EsPar( num1)
	SiNo
		Escribir num1, " es impar ", EsPar(num1)
	Fin Si
FinAlgoritmo
